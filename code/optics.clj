...
;Taken from https://github.com/jimpil/hotel-nlp/blob/master/src/hotel_nlp/algorithms/optics.clj
;
...
(defmulti dist  "Euclidian distances between a [point|matrix] and another point"
  (fn [a _] (class a)))
